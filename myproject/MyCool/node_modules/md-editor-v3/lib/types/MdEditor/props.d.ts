...
import { StaticTextDefaultKey, ToolbarNames, PreviewThemes, MdHeadingId, Themes, Footers, ChangeEvent, SaveEvent, UploadImgEvent, HtmlChangedEvent, GetCatalogEvent, ErrorEvent, EditorEmits, CustomIcon } from './type';
...
export declare const mdPreviewProps: {
     ...
     */
    language: {
        type: PropType<StaticTextDefaultKey | string>;
        default: string;
    };
    /**
     * html变化事件
